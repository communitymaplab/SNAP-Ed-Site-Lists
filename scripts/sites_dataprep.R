...
list.geojson<-list.files(path="data",pattern=".geojson")
...
sites<-gs_url("https://docs.google.com/spreadsheets/d/1C8PVwPmQXsQbSqegysNamNTtDkzsZlGSIeRkff2VgWI/edit?usp=sharing")
...
write_csv(sites_new,paste("data/geocodedsitelist_",Sys.Date(),".csv",sep=""))
